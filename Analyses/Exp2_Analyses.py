...
#SPECIFY
df = pd.read_excel('StoryEvolution_AllData_Corrected.xlsx', sheet_name='Exp2_Canon')
...
Can_df_AllCorr.to_excel("Exp2_Canon_OrderComparisonAcrossSubs_Spacy.xlsx",sheet_name='SentCorrelations')
...
plt.savefig('Exp2_Can_Spacy_CorrOrder_Next')
plt.clf()
...
Can_df_AllCorr = pd.DataFrame.transpose(Can_df_AllCorr)
print(Can_df_AllCorr)
Can_df_AllCorr.to_excel("Exp2_Canon_OrderComparisonAcrossSubs_Spacy_Backwards.xlsx",sheet_name='SentCorrelations')
...
plt.savefig('Exp2_Can_Spacy_CorrOrder_Backwards')
plt.clf()
...
plt.savefig('Exp2_Can_Spacy_CorrOrdertoLast')
plt.clf()
...
Can_df_AllCorr_Last.to_excel("Exp2_Canon_OrderComparisontoLast_Spacy.xlsx",sheet_name='SentCorrelations')
...
plt.savefig('Exp2_Can_Spacy_CorrOrdertoLast_RefLast')
plt.clf()
...
Can_df_AllCorr_Last = pd.DataFrame.transpose(Can_df_AllCorr_Last)
print(Can_df_AllCorr_Last)
Can_df_AllCorr_Last.to_excel("Exp2_Canon_OrderComparisontoLast_Spacy_RefLast.xlsx",sheet_name='SentCorrelations')
...
plt.savefig('Exp2_Can_Spacy_CorrOrdertoFirst_InitialReference')
plt.clf()
...
Can_df_AllCorr_First.to_excel("Exp2_Canon_OrderComparisontoFirst_Spacy.xlsx",sheet_name='SentCorrelations')
...
plt.savefig('Exp2_Can_Spacy_CorrOrdertoFirst_OtherReference')
plt.clf()
...
Can_df_AllCorr_First = pd.DataFrame.transpose(Can_df_AllCorr_First)
print(Can_df_AllCorr_First)
Can_df_AllCorr_First.to_excel("Exp2_Canon_OrderComparisontoFirst_Spacy_RefOther.xlsx",sheet_name='SentCorrelations')
...
#SPECIFY...
df = pd.read_excel('StoryEvolution_AllData_Corrected.xlsx', sheet_name='Exp2_NonCanon')
...
#SPECIFY...
story=open("sara_scrambled.txt").read()
doc0=nlp(story)
noStop= [token.text for token in doc0 if not token.is_stop]
doc0_noStop = nlp(' '.join(noStop))
...
Non_df_AllCorr.to_excel("Exp2_NonCanon_OrderComparisonAcrossSubs_Spacy.xlsx",sheet_name='SentCorrelations')
...
plt.savefig('Exp2_Non_Spacy_CorrOrder_Next')
plt.clf()
...
Non_df_AllCorr = pd.DataFrame.transpose(Non_df_AllCorr)
print(Non_df_AllCorr)
Non_df_AllCorr.to_excel("Exp2_NonCanon_OrderComparisonAcrossSubs_Spacy_Backward.xlsx",sheet_name='SentCorrelations')
...
plt.savefig('Exp2_Non_Spacy_CorrOrder_Next_Backward')
plt.clf()
...
plt.savefig('Exp2_Non_Spacy_CorrOrdertoLast')
plt.clf()
...
Non_df_AllCorr_Last.to_excel("Exp2_NonCanon_OrderComparisontoLast_Spacy.xlsx",sheet_name='SentCorrelations')
...
plt.savefig('Exp2_Non_Spacy_CorrOrdertoLast_LastRef')
plt.clf()
...
Non_df_AllCorr_Last = pd.DataFrame.transpose(Non_df_AllCorr_Last)
print(Non_df_AllCorr_Last)
Non_df_AllCorr_Last.to_excel("Exp2_NonCanon_OrderComparisontoLast_Spacy_LastRef.xlsx",sheet_name='SentCorrelations')
...
plt.savefig('Exp2_Non_Spacy_CorrOrdertoFirst_InitialReference')
plt.clf()
...
Non_df_AllCorr_First.to_excel("Exp2_NonCanon_OrderComparisontoFirst_Spacy.xlsx",sheet_name='SentCorrelations')
...
plt.savefig('Exp2_Non_Spacy_CorrOrdertoFirst_OtherReference')
plt.clf()
...
Non_df_AllCorr_First = pd.DataFrame.transpose(Non_df_AllCorr_First)
print(Non_df_AllCorr_First)
Non_df_AllCorr_First.to_excel("Exp2_NonCanon_OrderComparisontoFirst_Spacy_OtherRef.xlsx",sheet_name='SentCorrelations')
...
plt.savefig('Exp2_Spacy_CorrOrdertoAcross')
plt.clf()
...
plt.savefig('Exp2_Spacy_CorrOrdertoAcross_Backwards')
plt.clf()
...
plt.savefig('Exp2_Spacy_CorrOrdertoLast')
plt.clf()
...
plt.savefig('Exp2_Spacy_CorrOrdertoLast_LastRef')
plt.clf()
...
plt.savefig('Exp2_Spacy_CorrOrdertoFirst_Initial Reference')
plt.clf()
...
plt.savefig('Exp2_Spacy_CorrOrdertoFirst_Backwards')
plt.clf()


## Average Similarity across Both References (for both conditions, and all three measures)
Can_df_AllCorr_other=pd.read_excel("Exp2_Canon_OrderComparisontoFirst_Spacy_RefOther.xlsx",sheet_name='SentCorrelations')
Can_df_AllCorr_First=pd.read_excel("Exp2_Canon_OrderComparisontoFirst_Spacy.xlsx",sheet_name='SentCorrelations')
Can_df_AllCorr_RefLast=pd.read_excel("Exp2_Canon_OrderComparisontoLast_Spacy_RefLast.xlsx",sheet_name='SentCorrelations')
Can_df_AllCorr_Last=pd.read_excel("Exp2_Canon_OrderComparisontoLast_Spacy.xlsx",sheet_name='SentCorrelations')
Can_df_AllCorr_back=pd.read_excel("Exp2_Canon_OrderComparisonAcrossSubs_Spacy_Backwards.xlsx",sheet_name='SentCorrelations')
Can_df_AllCorr_front=pd.read_excel("Exp2_Canon_OrderComparisonAcrossSubs_Spacy.xlsx",sheet_name='SentCorrelations')

Can_df_First = (Can_df_AllCorr_other + Can_df_AllCorr_First)/2
Can_df_First.to_excel("Exp2_Canon_OrderComparisontoFirst_Average_Spacy.xlsx")
Can_df_Last = (Can_df_AllCorr_RefLast + Can_df_AllCorr_Last)/2
Can_df_Last.to_excel("Exp2_Canon_OrderComparisontoLast_Average_Spacy.xlsx")
Can_df_Across = (Can_df_AllCorr_back + Can_df_AllCorr_front)/2
Can_df_Across.to_excel("Exp2_Canon_OrderComparisonAcrossSubs_Average_Spacy.xlsx")

Non_df_AllCorr_other=pd.read_excel("Exp2_NonCanon_OrderComparisontoFirst_Spacy_OtherRef.xlsx",sheet_name='SentCorrelations')
Non_df_AllCorr_First=pd.read_excel("Exp2_NonCanon_OrderComparisontoFirst_Spacy.xlsx",sheet_name='SentCorrelations')
Non_df_AllCorr_RefLast=pd.read_excel("Exp2_NonCanon_OrderComparisontoLast_Spacy_LastRef.xlsx",sheet_name='SentCorrelations')
Non_df_AllCorr_Last=pd.read_excel("Exp2_NonCanon_OrderComparisontoLast_Spacy.xlsx",sheet_name='SentCorrelations')
Non_df_AllCorr_back=pd.read_excel("Exp2_NonCanon_OrderComparisonAcrossSubs_Spacy_Backward.xlsx",sheet_name='SentCorrelations')
Non_df_AllCorr_front=pd.read_excel("Exp2_NonCanon_OrderComparisonAcrossSubs_Spacy.xlsx",sheet_name='SentCorrelations')
...
Non_df_First.to_excel("Exp2_NonCanon_OrderComparisontoFirst_Average_Spacy.xlsx")
Non_df_Last.to_excel("Exp2_NonCanon_OrderComparisontoLast_Average_Spacy.xlsx")
Non_df_Across.to_excel("Exp2_NonCanon_OrderComparisonAcrossSubs_Average_Spacy.xlsx")
...
plt.savefig('Exp2_Spacy_CorrOrder_Across_Average')
plt.clf()
...
plt.savefig('Exp2_Spacy_CorrOrder_Initial_Average')
plt.clf()
...
plt.savefig('Exp2_Spacy_CorrOrder_Last_Average')
plt.clf()